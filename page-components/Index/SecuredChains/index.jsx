...
const SecuredChains = () => {
  return (
    <>
      <section class="text-gray-400 body-font min-h-screen" id='Secured-Chains'>
        <div className="container mx-auto flex lg:px-32 px-5 py-24 md:flex-row flex-col items-center min-h-screen ">
          <div className="lg:w-1/2 md:w-1/2 w-full p-5">
            ...
            <p className="mb-8 font-light text-gray-300">
              Blockchain networks that use “security as a service” instead of
              their own pool of authorizers. The security service can be
              provided directly by Ethereum or by professional validators.
              Secured chains tradeoff a portion of independence and flexibility
